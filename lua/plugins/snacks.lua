-- Put this outside the config block
local daily_quotes = {
...
local quote = daily_quotes[os.date("%j") % #daily_quotes + 1]

return {
	-- Plugin: Snacks.nvim
	-- Description: A Neovim plugin that provides a collection of utilities and enhancements for a better development experience.
